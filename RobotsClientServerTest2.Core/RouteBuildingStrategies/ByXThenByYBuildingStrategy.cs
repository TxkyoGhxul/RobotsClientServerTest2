...
/// </summary>
public class ByXThenByYBuildingStrategy : BaseRouteBuildingStrategy
{
    /// <inheritdoc />
    ...
    {
        if (directionToGoByX == Direction.None)
        {
            ...
            for (int i = Math.Abs(newPosition.Y) - 2; i > 0; i--)
            {
        ...
        TurnToTheRightDirection(currentRobotDirection, directionToGoByX);
        ...
        TurnToTheRightDirection(directionToGoByX, directionToGoByY);
